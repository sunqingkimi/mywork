...
import base.OkHttp;
public class api_v1_forecast_live {
    @DataProvider(name = "ApiData")
    public static Object[][] words() throws Exception {
        return CSVData2.getData("D:\\FirstAPITest\\src\\test\\java\\testdata\\weather_zuul\\api_v1_forecast_live.csv");
    }
    ...
    public void getTest(String caseID,String longitude,String latitude,String expectcode) {
        ...
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>> Test case: "
                + caseID+">>>>>>>>>>>>>>>>>>>>>>>");
        //从Excel文件中取出参数拼接URL
        String url = "http://10.27.22.26:8080/en-weather/api/v1/forecast/live?longitude="+longitude+"&latitude="
                +latitude;
        //调用接口
