...
public class ApiForecast {
    ...
    public static Object[][] words() throws Exception {
        return CSVData2.getData("D:\\FirstAPITest\\src\\test\\java\\testdata\\weather_zuul\\ApiForecast.csv");
    }
    ...
    public void getTest(String caseID,String masterId,String startTime,String length,String expectcode) {
        ...
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>> Test case: "
                + caseID+">>>>>>>>>>>>>>>>>>>>>>>");
        //从Excel文件中取出参数拼接URL
        String url = "http://10.27.22.26:8080/kong-ibm/api/forecast?masterId="+masterId+"&startTime="+startTime+"&length="+length;
        //调用接口
