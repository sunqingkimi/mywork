...
public class factdata {
    ...
    public Iterator<Object[]> Numbers() throws IOException{
        return (Iterator<Object[]>)new CSVData( "sequence\\FactDataController\\","factdata.csv");
    }
    ...
    public void getTest(Map<String, String> data) {
        ...
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>> Test case: "
                + caseID+">>>>>>>>>>>>>>>>>>>>>>>");
        //从Excel文件中取出参数拼接URL
        String url = "http://10.27.21.141:8080/api/fact/masterId/"+masterId+"/metrics/"+metrics+"/statistics/"+statistics+"?factDataSource="+factDataSource+"&startTime="+startTime+"&length="+length;
        //调用接口
