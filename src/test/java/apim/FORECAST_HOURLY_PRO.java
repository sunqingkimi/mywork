...
public class FORECAST_HOURLY_PRO {
    String host;
    @BeforeClass
    public void setUp() {
        addconfig Addconfig;
    ...
    public static Object[][] words() throws Exception {
        return CSVData2.getData("D:\\FirstAPITest\\src\\test\\java\\testdata\\apim\\FORECAST_HOURLY_PRO.csv");
    }
    ...
    public void getTest(String caseID,String weatherelement,String longitude,String latitude,String expectcode,String headerskey,String headersvalue) {
        ...
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>> Test case: "
                + caseID+">>>>>>>>>>>>>>>>>>>>>>>");
        //从Excel文件中取出参数拼接URL
        String url = host+"/en-weather/v2/api/forecast/pro/hourly?weatherelement="+weatherelement+"&longitude="+longitude+"&latitude="+latitude+"&metadata=true";
        //调用接口
