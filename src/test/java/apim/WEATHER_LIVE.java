...
public class WEATHER_LIVE {
    ...
    public static Object[][] words() throws Exception {
        return CSVData2.getData("D:\\FirstAPITest\\src\\test\\java\\testdata\\apim\\WEATHER_LIVE.csv");
    }
    @Test(testName = "心知实时数据接口",dataProvider = "ApiData",timeOut =10000)
    public void getTest(String caseID,String longitude,String latitude,String expectcode,String headerskey,String headersvalue) {
        ...
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>> Test case: "
                + caseID+">>>>>>>>>>>>>>>>>>>>>>>");
        //从Excel文件中取出参数拼接URL
        String url = host+"/en-weather/api/v1/forecast/live?longitude="+longitude+"&latitude="
                +latitude;
        //调用接口
