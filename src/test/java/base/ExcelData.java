...
//     */
//    public ExcelData(String path,String fileName, String caseName) {
//        super();
//        this.path = path;
...
//        sourceFile = directory.getCanonicalPath() + "\\src\\test\\java\\testdata\\"
//               + path + fileName + ".xls";
//        //sourceFile = directory.getCanonicalPath() + "\\src\\test\\"+ fileName + ".xls";
//        return sourceFile;
//    }
//
//}
